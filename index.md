...
<h3>Icon Examples</h3>
<div class="clearfix">
	<!-- BEGIN - COPIED FROM ICOMOON DEMO.HTML FILE -->
	<div class="glyph fs1">
	...
	<div class="glyph fs1">
		<div class="clearfix bshadow0 pbs">
			...
			<span class="mls"> icon-receipt-paper</span>
		</div>
		<fieldset class="fs0 size1of1 clearfix hidden-false">
	...
	<div class="glyph fs1">
		<div class="clearfix bshadow0 pbs">
			<span class="icon-receipt-xml">
				
			</span>
			<span class="mls"> icon-receipt-xml</span>
		</div>
		<fieldset class="fs0 size1of1 clearfix hidden-false">
	...
	<div class="glyph fs1">
		<div class="clearfix bshadow0 pbs">
			<span class="icon-receipt-required">
				
			</span>
			<span class="mls"> icon-receipt-required</span>
		</div>
		<fieldset class="fs0 size1of1 clearfix hidden-false">
	...
	<div class="glyph fs1">
		<div class="clearfix bshadow0 pbs">
			<span class="icon-receipt-OCR">
				
			</span>
			<span class="mls"> icon-receipt-OCR</span>
		</div>
		<fieldset class="fs0 size1of1 clearfix hidden-false">
	...
	<div class="glyph fs1">
		<div class="clearfix bshadow0 pbs">
			<span class="icon-receipt-electronic">
				
			</span>
			<span class="mls"> icon-receipt-electronic</span>
		</div>
		<fieldset class="fs0 size1of1 clearfix hidden-false">
	...
	<!-- END - COPIED FROM ICOMOON DEMO.HTML FILE -->
</div>

<h3>Icon Workflow</h3>
<p>Periodically, the UX team will provide us with updated icons. Here is the workflow that needs to be followed to get these files in place</p>
<ul>
	<li><strong>Updated font.zip sent from UX team</strong> Currently, Bryce is creating these files</li>
	<li><strong>Regenerate the fonts</strong> Unfortunately, the files that UX sends display correctly on a local webpage, but they do not display correctly when served via IIS. The only known fix is to regenerate the files.
		<ul>
			<li>Unzip the font.zip file</li>
			<li>Point your browser to http://icomoon.io/app/#browse </li>
			<li>If there are any icons loaded, click the reset icon in the lower righthand of the page</li>
			<li>If nessasary, chose the trash can icon and delete any remaining icons</li>
			<li>Click "Import Icons" button</li>
			<li>Navigate to the unzipped font directory, and choose the file called selection.json</li>
			<li>Click the "Font ->" button</li>
			<li>Under "Preferences" make sure:
				<ul>
					<li>Icon name is set to "concur-icons-{YYYYMMDD} (supply the current date)</li>
					<li>Class prefix is "icon-</li>
					<li>Generate Stylesheet variables for LESS</li>
					<li>use Attribute Selectors</li>
				</ul>
			</li>
			<li>Under "Codes" make sure we start at "e000"</li>
			<li>Click the "Download" button</li>
			<li>Unzip the fonts downloaded from icomoon</li>
			<li>SVN Replace the concur-icon font files in \static\fonts\ with the ones generated from icomoon</li>
		</ul>
	</li>
	<li><strong>Update the icons.less file</strong> Manually diff \static\less\cnqr-global\_components\_cnqr-icons.less against style.css provided with the fonts download from icomoon
		Please be on the lookout for:
		<ul>
			<li>New icons</li>
			<li>Altered char-codes</li>
			<li>Renamed icon class names</li>
		</ul>
	</li>
	<li><strong>Update the _variables-cnqr-icons.less file</strong> Replace all char codes with char-code variables located in \static\less\cnqr-global\_components\variables-cnqr-icons.less so they can be refererence elsewhere if needed. Use the _variables.less provided from icomoon</li>
	<li><strong>Update IconFont.cshtml (this file)</strong> Manually diff IconFont.cshtml with the demo.html file providede with the fonts downloaded from icomoon</li>
	<li><strong>Update the manual cachekilla for fonts</strong> In static\less\cnqr-bootstrap-3.3.1\custom\_variables.less, update the @@font-icon-cnqr-cachekilla to todays date string</li>
	<li>run C:\Outtask\Tools\UnitTests\iconsaudit.wsf to determine if any icons changed names. Update script and code code as needed.</li>
</ul>
